 ...
 * @author User
 */
public class KruskalMST extends MSTAlgorithm {
...
// this method is used to insert the all edes to list to sort
        ...
        Line  edge = new Line();
         Line help=null;
            for (int i =0 ;i<v.length;i++){
                if (v[i] !=null)
               help =(Line)(v[i].getEdges().getHead());
     
                  while (help !=null){
                    help.setSource(v[i]);
                    edgeList.add(help);
                     help=(Line) help.getNext();
      }
    ...
    public void createSet(Integer  data){
    ...
    public void  KruskalMST() {
        ...
        kruskalMST = new KruskalMST(graph);

        //Create as many groups as the total vertices.
        for (int i =0; i<v.length;i++) {
            if (v[i] !=null)
                //(char)(v[i].getLabel()+65)+""
            kruskalMST.createSet(Integer.parseInt(v[i].getLabel()));
        }
        ...
        for (Line  edge : edgeList) {
            ...
            Integer  root1 = kruskalMST.findSet(Integer.parseInt(edge.getSource().getLabel()));
            Integer root2 = kruskalMST.findSet(Integer.parseInt(edge.getTarget().getLabel()));
            ...
            if (root1.equals(root2)) {
                ...
                Integer source =(Integer.parseInt(edge.getSource().getLabel()));    
                Integer target =Integer.parseInt(edge.getTarget().getLabel());
